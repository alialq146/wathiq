...
export type TagColor = "slate" | "blue" | "teal";
...
export function Tag({ children, onRemove, color = "slate", style, ...rest }: TagProps) {
  const colors: Record<TagColor, { fg: string; bd: string; bg: string }> = {
