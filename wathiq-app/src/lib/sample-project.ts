...
export const SAMPLE_CONTEXT: ReportContext = {
  project: {
    ...
    color: null,
    icon: null,
    projectIdea: "منصة لإدارة طلبات العملاء واستقبال البيانات عبر القنوات المعتمدة وأتمتة متابعة كل طلب حتى إغلاقه.",
    projectGoal: "تقليل العمل اليدوي، تسريع معالجة الطلبات، وتحسين متابعة حالة كل طلب مع تقارير شهرية للإدارة.",
    targetUsers: "موظف خدمة العملاء، مدير خدمة العملاء، فريق التشغيل، الإدارة العليا.",
    projectScope: "استقبال الطلبات وتسجيلها، متابعة الحالة، إرسال الإشعارات، البحث والتصفية، وإصدار التقارير الشهرية.",
    outOfScope: "الدفع الإلكتروني، تطبيق الجوال، والتكامل مع أنظمة خارجية في المرحلة الحالية.",
    relatedSystems: "البريد الإلكتروني، الرسائل النصية، وبوابة داخلية للموظفين.",
    constraints: "حماية بيانات العملاء، والاستضافة داخل البنية المعتمدة لدى الجهة، وعدم إرسال بيانات حساسة عبر قنوات غير معتمدة.",
  },
  userName: "نموذج تجريبي — منصة وثّق",
  modules: [
    { id: "MOD-ORDERS", projectId: "PRJ-DEMO", name: "إدارة الطلبات", description: "تسجيل الطلبات ومتابعة حالتها والبحث فيها." },
    { id: "MOD-NOTIFY", projectId: "PRJ-DEMO", name: "الإشعارات", description: "إشعارات العملاء عند تغيّر حالة الطلب عبر القنوات المعتمدة." },
  ],
  requirements: [
    {
      id: "FR-001",
